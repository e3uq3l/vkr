...
\begin{figure}[H]
	\center{\includegraphics[width=0.65\linewidth]{client_component}}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.6\linewidth]{server_component}}
...
\begin{figure}[H]
	\center{\includegraphics[width=0.9\linewidth]{sequence}}
...
Компоненты, отвечающие за хранение данных и взаимодействие с СУБД, показаны на рисунке~\ref{fig:db_comp}.

\begin{figure}[H]
	\center{\includegraphics[scale=0.7]{db_component}}
	\caption{Диаграмма компонентов базы данных}
	\label{fig:db_comp}
\end{figure}

Внешней средой является СУБД PostgreSQL, встроенная через pgembed. Модуль \texttt{connection.py} управляет процессом PostgreSQL, создаёт пул соединений \texttt{ThreadedConnectionPool} (от 2 до 10 потокобезопасных соединений) и предоставляет методы \texttt{get\_connection()} и \texttt{return\_connection()} для остальных модулей.
...
На основе анализа предметной области были выделены основные сущности и связи между ними. ER-диаграмма (Entity-Relationship diagram, диаграмма «сущность-связь») представляет собой графическую схему, которая показывает, какие данные присутствуют в системе и как они связаны друг с другом. На рисунке \ref{er:image} представлена ER-диаграмма базы данных.

\begin{figure}[H]
	\center{\includegraphics[width=1\linewidth]{er}}
...
\begin{figure}[H]
	\center{\includegraphics[scale=0.2]{rel}}
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «students» (Слушатели)\label{tab:students}}\\ \hline
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «student\_status» (Статусы слушателей)\label{tab:student_status}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «prior\_education» (Предыдущее образование)\label{tab:prior_education}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «education\_level» (Уровни образования)\label{tab:education_level}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «student\_group» (Связь слушателей с группами)\label{tab:student_group}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «groups» (Группы)\label{tab:groups}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «programs» (Программы обучения)\label{tab:programs}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «program\_type» (Типы программ)\label{tab:program_type}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «learning\_form» (Формы обучения)\label{tab:learning_form}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «professional\_field» (Области профессиональной деятельности)\label{tab:professional_field}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «economic\_activity» (Виды экономической деятельности)\label{tab:economic_activity}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «ugs» (Укрупнённые группы специальностей)\label{tab:ugs}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «qualification» (Квалификации)\label{tab:qualification}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «financing» (Финансирование)\label{tab:financing}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «funding\_source» (Источники финансирования)\label{tab:funding_source}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «customer\_type» (Типы заказчиков)\label{tab:customer_type}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «documents» (Документы о квалификации)\label{tab:documents}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «document\_type» (Виды документов)\label{tab:document_type}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «document\_status» (Статусы документов)\label{tab:document_status}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
...
\begin{xltabular}{\textwidth}{|c|c|l|l|X|}
	\caption{Атрибуты таблицы «users» (Пользователи системы)\label{tab:users}}\\ \hline
	\centrow Key Type & \centrow Optionality & \centrow Column name & \centrow Data Type & \centrow Size \\ \hline
	\endfirsthead
